...
test("diff emits text, prop, and create patches with stable paths", () => {
  ...
  assert.deepEqual(patches, [
    ...
    { kind: "CREATE", path: [2, 2], node: { type: "li", props: {}, children: [{ type: "TEXT", props: { nodeValue: "Seasonal fruit" }, children: [] }] } },
  ]);
});
...
test("diff replaces the root when node types differ", () => {
  ...
  assert.deepEqual(patches, [{ kind: "REPLACE", path: [], node: replacedRootTree }]);
});
            ...
            children: [
              {
                type: "p",
                props: {},
                children: [{ type: "TEXT", props: { nodeValue: "deep value changed" }, children: [] }],
              },
            ],
          },
        ],
...
test("diff ignores event props and emits remove patches for trailing children", () => {
  const oldTree = {
    ...
    children: [
      { type: "span", props: {}, children: [{ type: "TEXT", props: { nodeValue: "A" }, children: [] }] },
      { type: "span", props: {}, children: [{ type: "TEXT", props: { nodeValue: "B" }, children: [] }] },
    ],
  };
  const newTree = {
    type: "div",
